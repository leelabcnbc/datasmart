...
FileTransferSiteAuto = jsl.OneOfField([jsl.DocumentField(FileTransferSiteRemoteAuto),
                                       jsl.DocumentField(FileTransferSiteLocalAuto)], required=True)
FileTransferSiteStandard = jsl.OneOfField([jsl.DocumentField(FileTransferSiteLocal),
                                           jsl.DocumentField(FileTransferSiteRemote)], required=True)
FileTransferSiteAny = jsl.OneOfField([jsl.DocumentField(FileTransferSiteRemote),
                                      jsl.DocumentField(FileTransferSiteLocal),
                                      jsl.DocumentField(FileTransferSiteRemoteAuto),
                                      jsl.DocumentField(FileTransferSiteLocalAuto)], required=True)
